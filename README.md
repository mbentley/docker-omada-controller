...
| :----- | ------------------- | --------------- |
| `latest`, `5.3` | Omada Controller `5.3.x` | `5.3.1` |
...
| :----- | ------------------- | ---------- |
| `latest-amd64`, `5.3-amd64` | Omada Controller `5.3.x` | `mbentley/ubuntu:20.04` |
...
| :----- | ------------------- | ---------- |
| `latest-arm64`, `5.3-arm64` | Omada Controller `5.3.x` | `mbentley/ubuntu:20.04` |
...
docker run -d \
  ...
  -v omada-work:/opt/tplink/EAPController/work \
  -v omada-logs:/opt/tplink/EAPController/logs \
  mbentley/omada-controller:5.3-armv7l
```
...
docker run -d \
  ...
  -v omada-work:/opt/tplink/EAPController/work \
  -v omada-logs:/opt/tplink/EAPController/logs \
  mbentley/omada-controller:5.3-arm64
```
