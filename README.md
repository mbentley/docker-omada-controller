...
* `latest`, `4.4` - Omada Controller 4.4.x (currently 4.4.6)
...
* `latest-armv7l`, `4.4-armv7l` - Omada Controller 4.4.x (currently 4.4.6)
...
* `latest-arm64`, `4.4-arm64` - Omada Controller 4.4.x (currently 4.4.6)
